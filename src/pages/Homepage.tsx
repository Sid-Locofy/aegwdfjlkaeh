              ...
              <div className={styles.flightDetails}>
                ...
                <div className={styles.prepareMenu}>
                  ...
                  <div className={styles.tripMenus}>
                    <Hotel hotelIcon="../hotel-icon.svg" hotel="Hotel" />
                    <Attractions
                      ticket="../ticket.svg"
                      attractions="Attractions"
                    />
                    <Hotel
                      hotelIcon="../eats-icon.svg"
                      hotel="Eats"
                      hotelTextAlign="center"
                    />
                    <Attractions
                      backgroundBackgroundColor="#fdbf00"
                      ticket="../vector.svg"
                      ticketHeight="48.43%"
                      ticketWidth="41.17%"
                      ticketTop="26.51%"
                    ...
                    />
                    <Attractions
                      backgroundBackgroundColor="#4dabff"
                      ticket="../vector1.svg"
                      ticketHeight="40.15%"
                      ticketWidth="40.52%"
                      ticketTop="29.63%"
                      ...
                      ticketLeft="29.74%"
                      attractions="Taxi"
                      attractionsIconWidth="70px"
                      backgroundWidth="70px"
                      attractionsDisplay="inline-block"
                      attractionsWidth="32.12px"
                    />
                    <Attractions
                      backgroundBackgroundColor="#79ca00"
                      ticket="../vector2.svg"
                      ticketHeight="35.6%"
                      ticketWidth="39.93%"
                      ticketTop="32.2%"
